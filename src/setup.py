...
class Setup:
    ...
    def openSingleSpectrum(self, wavelength, flux, error, r_instrument):
        ...
        self.mask_emissionlines(self.emlines)
    ...
    def openMANGASpectrum(self, path_to_logcube, path_to_dapall, bin_number, plate_number, ifu_number, emlines,mpl='mpl-9'):
        ...
        get = np.where(dap_all[ext].data['PLATEIFU']==f'{plate_number}-{ifu_number}')
